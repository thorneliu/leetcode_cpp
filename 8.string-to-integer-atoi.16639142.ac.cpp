...
public:
    int myAtoi(string str) {
        ...
        if (pos < str.size())
        {
            ...
            if (c == '-') negetive = true;
            if (isdigit(c)) digitList.push_back(c - '0');
        ...
        return convert(digitList, negetive);
    }

private:
    int convert(vector<int>& digitList, bool negetive)
    {
        long res = 0;
        if (digitList.empty()) return 0;
